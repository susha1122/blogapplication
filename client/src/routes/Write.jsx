  ...
  return <div  className='h-[calc(100vh-64px)] md:h-[calc(100vh-80px)] flex flex-col gap-6'>
    ...
    <form onSubmit={handleSubmit} className='flex flex-col gap-6 flex-1 mb-6'>
      <Upload type="image" setProgress={setProgress} setData={setCover}>
        <button type="button" className='w-max p-2 shadow-md rounded-xl test-sm test-gray-500 bg-white'>
          Add a cover image
        </button>
      </Upload>
      ...
      className='bg-blue-800 text-white font-medium rounded-xl mt-4 p-2 w-36 disabled:bg-blue-400 disabled:cursor-not-allowed'>{mutation.isPending ? "Loading..." : "Send"}</button>
      {"Progress:" + progress}
